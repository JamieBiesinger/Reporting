...
SELECT
  ...
  -- ,SubRegionhhhhhhhh
   ...
   ,CASE WHEN ISNULL(region, '') NOT IN ( 'New England', 'N. Cal - CTDN',
              ...
              AND EyeOutcome IN ( 'Recovered Donor', 'Suitable, Not Recovered' )
   ...
   ,CASE WHEN ISNULL(region, '') NOT IN ( 'New England', 'N. Cal - CTDN',
              ...
              AND tissueoutcomedetail IN ( 'CBNR - Logistics', 'NSFT - Hold',
                                           'NSFT - Research', 'Discard',
                                           'Transplant' )
              AND NOT ( [Discussion Type] = 'Confirmation'
                        AND EyeOutcomeDetail = 'Family Decline'
...
' )
              ...
              AND ISNULL(region, '') NOT IN ( 'New England', 'N. Cal - CTDN' )
         THEN 1
